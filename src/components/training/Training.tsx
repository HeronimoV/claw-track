...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      { title: 'Universal Cold Call Opening', content: `**Pattern Interrupt:** "Hey [Name], this is [Your Name] with ClawReady — I know I'm catching you out of the blue, so I'll be quick."
...
**Pain Points:** No-shows, front desk overload, insurance follow-up, staff turnover ($5-8K per replacement).` },
      { title: 'Gatekeeper Scripts', content: `**Receptionist Block:** "Totally understand — [Name] is busy. This is actually about saving their team 15-20 hours a week on admin work. Could you let them know [Your Name] from ClawReady called?"
...
**Voicemail:** "Hey [Name], [Your Name] with ClawReady. I work with [industry] businesses in [area] to automate operations. Most save 15-20 hours a week. Worth a quick chat? My number is [number]."` },
    ],
  },
  {
...
**"We don't have the budget"** → "How much are you spending on the problem this solves? Most clients find ClawReady pays for itself in month one."
...
**"We already use [other tool]"** → "Great — ClawReady integrates with your existing tools. It's the employee who actually keeps your CRM updated."` },
    ],
  },
  {
...
**Elevator Pitch:** "ClawReady deploys AI assistants that handle your email, scheduling, lead follow-up, and client communication — 24/7. We set it up in 2 weeks and it costs less than a part-time employee."
  ...
  return (
    <div className="h-full overflow-y-auto p-4 bg-gray-50">
      ...
      <div className="grid grid-cols-4 gap-2 mb-4">
        {DOWNLOADS.map(d => (
          <a key={d.file} href={d.file} download className="flex items-center gap-2 px-3 py-2.5 bg-white border border-gray-200 rounded-lg text-xs font-medium text-gray-700 hover:border-[#DC2626] hover:text-[#DC2626] transition-all">
