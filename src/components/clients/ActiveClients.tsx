  ...
  if (loading) {
    return (
      <div className="flex-1 flex items-center justify-center">
        <div className="w-8 h-8 border-4 border-gray-200 border-t-[#DC2626] rounded-full animate-spin" />
      </div>
    );
  }
    ...
    <div className="flex-1 overflow-auto p-6 bg-gray-50">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="px-5 py-2.5 bg-[#DC2626] hover:bg-[#B91C1C] text-white font-medium rounded-lg transition-all hover:shadow-lg hover:shadow-red-500/20"
        >
          + Add Client
        </button>
      </div>
        ...
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 p-4 overflow-auto" onClick={() => setModalView('none')}>
          <div className="bg-white rounded-2xl p-6 w-full max-w-2xl shadow-2xl my-8 max-h-[90vh] overflow-auto" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button onClick={handleAdd} disabled={!formData.company_name?.trim()} className="flex-1 py-2.5 text-sm font-medium rounded-lg bg-[#DC2626] hover:bg-[#B91C1C] text-white transition-all disabled:opacity-50">Add Client</button>
            </div>
          </div>
        </div>
      )}
                ...
                <div className="flex gap-2">
                  {editMode ? (
                    <>
                      ...
                      <button onClick={handleUpdate} className="px-4 py-2 text-sm font-medium rounded-lg bg-[#DC2626] text-white hover:bg-[#B91C1C]">Save Changes</button>
                    </>
                  ) : (
                    <>
              ...
              <div>
                ...
                <div className="mb-4 space-y-2">
                  ...
                  <button
                    ...
                    className="w-full py-2 text-xs font-medium rounded-lg bg-[#DC2626] hover:bg-[#B91C1C] text-white transition-all disabled:opacity-50"
                  >
                    Add Note
                  </button>
                </div>
