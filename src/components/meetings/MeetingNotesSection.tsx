      ...
      <div className="flex items-center justify-between mb-3">
        ...
        {!collapsed && !showForm && (
          <button
            ...
            className="px-3 py-1.5 text-xs font-medium rounded-lg bg-[#DC2626] hover:bg-[#B91C1C] text-white transition-all"
          >
            + Add Meeting Note
          </button>
        )}
          ...
          {showForm && (
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4 space-y-3">
              ...
              <div className="flex gap-2 justify-end">
                ...
                <button onClick={handleSave} disabled={saving} className="px-4 py-2 text-sm font-medium rounded-lg bg-[#DC2626] hover:bg-[#B91C1C] text-white transition-all disabled:opacity-50">
