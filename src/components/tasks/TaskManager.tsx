    ...
    <div className="h-full overflow-y-auto p-4 bg-gray-50">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => openAdd()} className="px-4 py-2 bg-[#DC2626] text-white text-xs font-medium rounded-lg hover:bg-[#B91C1C] transition-all">
            + Add Task
          </button>
        </div>
      </div>
          ...
          return (
            <div key={member} className="bg-white border border-gray-200 rounded-xl overflow-hidden">
              ...
              <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
                ...
                <button onClick={() => openAdd(member)} className="px-2.5 py-1 text-[10px] font-medium text-[#DC2626] border border-[#DC2626]/20 rounded-lg hover:bg-red-50 transition-all">
                  + Add
                </button>
              </div>
        ...
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50" onClick={() => setShowModal(false)}>
          <div className="bg-white rounded-xl p-6 w-full max-w-lg space-y-4" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button onClick={handleSave} disabled={!form.title.trim()} className="px-4 py-2 bg-[#DC2626] text-white text-sm font-medium rounded-lg hover:bg-[#B91C1C] disabled:opacity-50">
