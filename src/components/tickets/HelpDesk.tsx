          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-2.5 text-sm font-medium rounded-lg bg-[#DC2626] hover:bg-[#B91C1C] text-white transition-all disabled:opacity-50"
              >
                Create Ticket
              </button>
            </div>
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-2xl" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-2.5 text-sm font-medium rounded-lg bg-[#DC2626] hover:bg-[#B91C1C] text-white transition-all"
              >
                Save Solution
              </button>
            </div>
