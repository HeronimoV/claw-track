  ...
  const contracts = [
    {
      ...
      file: '/ClawReady-Growth-Agreement.pdf',
      tier: 'Growth',
      color: '#DC2626',
    },
    {
      ...
      file: '/ClawReady-Enterprise-Agreement.pdf',
      tier: 'Enterprise',
      color: '#111827',
    },
  ];
        ...
        {contracts.map(contract => (
          ...
          >
            ...
            <a
              href={contract.file}
              download
              className="inline-flex items-center gap-2 w-full justify-center px-5 py-3 bg-[#DC2626] hover:bg-[#B91C1C] text-white font-medium rounded-lg transition-all hover:shadow-lg hover:shadow-red-500/20"
            >
